...
mi passive: egen no_unemployed 	 =total(occupation_1==1), by(hhid)
mi passive: egen no_self_employed=total(occupation_2==1), by(hhid)
mi passive: egen no_employer     =total(occupation_3==1), by(hhid)
mi passive: egen no_employee     =total(occupation_4==1 | occupation_5==1), by(hhid)
