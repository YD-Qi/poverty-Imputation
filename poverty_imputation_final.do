...
rename (miembros agua elect propieta auto moto bici televisor lavarropas heladera precaria)(members water_access elect_access own_home car motor bike tv wash_machine fridge bad_loc)
...
global sum_1 "sex age_group_1-age_group_5 edu_group_1-edu_group_4 sector_2-sector_9 occupation_2-occupation_5 emp_status_1 emp_status_2 emp_status_3"
global sum_2 "parish_1-parish_10 no_unemployed no_employer no_employee_priv no_employee_pub no_secondary no_tertiary members member_sq own_home wash_machine fridge telef tv n_bedroom car computer"

bys year: sum $sum_1 $sum_2 [w=nweight]
...
putexcel set "/Users/yd/Dropbox/Imputation/poverty_imputation results.xlsx", sheet(imputed poverty) modify
loc c=20

	global head_char "sex age_group_2-age_group_5 edu_group_2-edu_group_4 sector_7-sector_9 occupation_2-occupation_4 emp_status_2 emp_status_3"
	global hh_char "parish_2-parish_10 no_unemployed no_employer no_employee_priv no_employee_pub no_secondary no_tertiary members member_sq own_home wash_machine fridge telef tv n_bedroom car computer"
...
local years "2016 2015 2014 2012 2011 2009 2008"
		...
		global head_char "sex relation hhid age_group edu_group emp_status sector occupation unemployed emp_status"
		global hh_char "no_dependent urban parish members member_sq own_home wash_machine fridge telef n_bedroom car computer tv"
